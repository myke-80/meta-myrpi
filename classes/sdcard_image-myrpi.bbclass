...
# <-----------------------> <----------> <----------------------> <----------------------> 
#  ------------------------ ------------ ------------------------ ------------------------ 
# | IMAGE_ROOTFS_ALIGNMENT | BOOT_SPACE | ROOTFS_SIZE            | ROOTFS_SIZE            |
#  ------------------------ ------------ ------------------------ ------------------------ 
# ^                        ^            ^                        ^                        ^
# |                        |            |                        |                        |
# 0                      4MiB     4MiB + 40MiB            4MiB + 40Mib +             4MiB + 40Mib + 
#                                                           SDIMG_ROOTFS             SDIMG_ROOTFS + 
#                                                                                    SDIMG_ROOTFS   

# This image depends on the rootfs image
IMAGE_TYPEDEP_myrpi-sdimg = "${SDIMG_ROOTFS_TYPE}"
...
IMAGE_CMD_myrpi-sdimg () {
	...
	echo "Creating filesystem with Boot partition ${BOOT_SPACE_ALIGNED} KiB and RootFS $ROOTFS_SIZE KiB (twice)"
